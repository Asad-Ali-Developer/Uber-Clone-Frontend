...
const RidePopupModal = ({ setRidePopupModal }: Props) => {
  return (
    <div className="px-2 py-4">
      ...
      <div className="flex flex-col gap-2 items-center w-full">
        ...
        <button
          ...
          // }}
          className="bg-green-600 hover:bg-green-700 text-white w-full px-4 py-3 rounded-md font-medium mt-5"
        >
          Confirm
        </button>
        <button
          onClick={() => setRidePopupModal(false)}
          className="bg-zinc-200 hover:bg-zinc-300 w-full px-4 py-3 rounded-md font-medium"
        >
          Cancel
        </button>
      </div>
